...
public class OrderController {
    ...
    public Result bathSend(List<Order> orders){
        orderService.bathSend(orders);
        return new Result(true,StatusCode.OK,"发货成功");
    }
    @PostMapping("/confirmTask/{orderId}/{operator}")
    public Result confirmTask(@PathVariable("orderId") String orderId, @PathVariable("operator") String operator){
