...
public class SkuController {
    ...
    @RequestMapping("/recoverStockNum")
    public Result recoverStockNum(@RequestParam("skuId")String skuId, @RequestParam("num") Integer num){

        skuService.recoverStockNum(skuId, num);
